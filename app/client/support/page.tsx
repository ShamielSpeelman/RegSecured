...
import type { Message } from "@/components/client/communications/message-center"
...
import { SupportChatSection } from "@/components/client/support/support-chat-section"
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <SupportChatSection messages={supportMessages} faqs={faqs} />
          </div>
